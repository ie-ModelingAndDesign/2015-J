...
class Outputmenu: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        myButton.setBackgroundImage(UIImage(named: "kansan_10.png"), forState: UIControlState.Normal)
        ...
        listViewButton.setBackgroundImage(UIImage(named: "list_10.png"), forState: UIControlState.Normal)
        ...
        graphViewButton.setBackgroundImage(UIImage(named: "graph_10.png"), forState: UIControlState.Normal)
